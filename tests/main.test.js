...
const assertCorrectJson = (result) => {
  assert.notEqual(result, null);
  assert.equal(Array.isArray(result), true);
...
describe('Node.js environment', () => {
  describe('Negative cases', () => {
    ...
    it('with correct spreadsheet ID, but with wrong type of "isJson" option (not NULL!)', async () => {
      let result = null;
  ...
  describe('Positive cases', () => {
    ...
    it('with public spreadsheet ID and as JSON', async () => {
      const result = await readSpreadsheet(publicSpreadsheetId, {
        isJson: true,
      });
    ...
    it('with public spreadsheet ID and JSON as stream', async () => {
      const result = await readSpreadsheet(publicSpreadsheetId, {
        isJson: true,
        isStream: true,
      });
