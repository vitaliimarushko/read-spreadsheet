 ...
 * @returns {Readable | string} in case of successful operation it will return readable stream or string, in opposite case - empty array
 * @throws {Promise<Error>}
 */
module.exports = async (spreadsheetId, options = {}) => {
  const {throwable = false, gid = null} = options || {};
  ...
  if (
    !isBrowser &&
    response.data.responseUrl.startsWith(
