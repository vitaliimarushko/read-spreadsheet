module.exports = {
  ERROR: {
    ...
    CANT_BE_READ: new Error(
      `Spreadsheet document content can't read by some reasons`,
    ),
    WAS_NOT_BUILD: new Error(`Content wasn't built from stream`),
    WRONG_RESPONSE: new Error(
      'Wrong response after requesting spreadsheet document',
    ),
